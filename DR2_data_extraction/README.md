...
- [`src/goldrush2/dr2/collectors/`](src/goldrush2/dr2/collectors/) — shared source collectors.
- [`src/goldrush2/dr2/extractors/`](src/goldrush2/dr2/extractors/) — per-variable extraction rules.
- [`config/refresh_policies.yaml`](config/refresh_policies.yaml) — refresh behavior.
- [`data/raw/`](data/raw/), [`data/cache/`](data/cache/), and [`data/current/`](data/current/) — source, normalized, and current-variable artifacts.
- [`scripts/`](scripts/) and [`tests/`](tests/) — source diagnostics, backfills, and extraction tests.
