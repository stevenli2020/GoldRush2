...
from goldrush2.dr2.collectors.wgc import LAST_FETCH_STALE, LAST_FETCH_USED_CACHE, fetch_wgc_gold_premiums
from goldrush2.dr2.extractors._wgc_common import parse_date
...
RAW_PATH = PROJECT_ROOT / "data/raw/wgc/gold-premiums.xlsx"
PARSED_CACHE_PATH = PROJECT_ROOT / "data/cache/wgc/gold_premiums.json"
OUTPUT_PATH = PROJECT_ROOT / "data/current/L9-001.json"
