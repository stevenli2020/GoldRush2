...
FRED_DFF_RAW_PATH = DR2_ROOT / "data" / "raw" / "fred" / "DFF.json"
FRED_TARMD_RAW_PATH = DR2_ROOT / "data" / "raw" / "fred" / "FEDTARMD.json"
RAW_CME_PATH = cme.DEFAULT_RAW_PATH
MANIFEST_CME_PATH = cme.DEFAULT_MANIFEST_PATH
OUTPUT_PATH = DR2_ROOT / "data" / "current" / "L1-006.json"
SHARED_RATE_CACHE_PATH = DR2_ROOT / "data" / "cache" / "L1-006.json"
