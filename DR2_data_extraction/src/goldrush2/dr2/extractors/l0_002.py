...
from goldrush2.dr2.extractors._wgc_common import HORIZON_LOOKBACKS, build_output as _build_output, cumulative_net_change_series, degraded
...
def parse_holdings_workbook(path: Path, *, cache_path: Path | None = PARSED_CACHE_PATH) -> list[dict[str, Any]]:
