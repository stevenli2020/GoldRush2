"""DR2 extractor for L2-002: broad trade-weighted nominal US dollar index."""
...
VARIABLE_ID = "L2-002"
SERIES_ID = "DTWEXBGS"
SOURCE_NAME = "FRED DTWEXBGS - Broad Trade-Weighted Nominal US Dollar Index"
...
def build_output(observations: list[dict[str, str | float]], *, cached: bool = False, as_of_date: str | None = None) -> dict[str, Any]:
    """Build the four-horizon L2-002 result from valid FRED observations."""
...
def run(*, raw_path: Path = RAW_PATH, output_path: Path = OUTPUT_PATH) -> dict[str, Any]:
    """Fetch DTWEXBGS, apply seven-day cache rules, and write current output."""
    try:
