...
CACHE_PATH=PROJECT_ROOT / "data/cache/L6-002.json"
def _score(e):
    ...
    return min(100,s)
def run(cache_path=CACHE_PATH, output_path=PROJECT_ROOT / "data/current/L6-002.json", force_refresh=False, verbose=0):
