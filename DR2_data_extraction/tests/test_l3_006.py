...
from goldrush2.dr2.extractors import l3_006
from goldrush2.dr2.ai import fomc_scorer
...
def test_calendar_parser(monkeypatch):
    ...
    monkeypatch.setattr("goldrush2.dr2.collectors.fed.urlopen", lambda *a, **k: Response())
