...
from goldrush2.dr2.extractors import l5_002
...
def test_parser_reuses_shared_persistent_cache(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("goldrush2.dr2.extractors._wgc_common.parse_official_changes_workbook", lambda path: (_ for _ in ()).throw(AssertionError("XLSX was parsed again")))
