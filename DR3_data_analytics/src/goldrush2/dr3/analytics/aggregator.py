...
from goldrush2.dr3.analytics.models import AggregatedResult, HorizonScore, VariableResult
from goldrush2.paths import DR2_CURRENT_DIR, DR3_CONFIG_DIR, DR3_SCORES_PATH

WEIGHTS_FILE = DR3_CONFIG_DIR / "weights_v1.yaml"
SCORES_OUTPUT_FILE = DR3_SCORES_PATH
...
def load_variable_results(data_dir: Optional[Path] = None) -> dict[str, VariableResult]:
    directory = data_dir or DR2_CURRENT_DIR
    results = {}
