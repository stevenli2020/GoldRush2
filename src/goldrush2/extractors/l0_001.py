...
from goldrush2.collectors.wgc import LAST_FETCH_STALE, LAST_FETCH_USED_CACHE, fetch_wgc_above_ground_stocks

VARIABLE_ID = "L0-001"
SOURCE_NAME = "WGC GoldHub - Above-Ground Gold Stock (tonnes)"
SOURCE_URL = "https://www.gold.org/goldhub/data/how-much-gold"
PARSED_CACHE_PATH = Path("data/cache/wgc/l0_001.json")
OUTPUT_PATH = Path("data/current/L0-001.json")
