...
VARIABLE_ID="L3-002"; SOURCE_NAME="USD SOFR OIS Curve - 1Y policy path"; SOURCE_URL="https://cadampog.com/temp/datafeed/"
PROJECT_ROOT=Path(__file__).resolve().parents[3]; CACHE_PATH=PROJECT_ROOT/"data"/"cache"/"ois"/"ois_curves.json"; OUTPUT_PATH=PROJECT_ROOT/"data"/"current"/"L3-002.json"
