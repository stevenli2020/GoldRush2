...
from goldrush2.extractors._ois_common import HORIZONS, change_horizon, valid_series
VARIABLE_ID="L3-003"; SOURCE_NAME="USD SOFR OIS Curve - fixed 2Y terminal proxy"; SOURCE_URL="https://cadampog.com/temp/datafeed/"
PROJECT_ROOT=Path(__file__).resolve().parents[3]; CACHE_PATH=PROJECT_ROOT/"data"/"cache"/"ois"/"ois_curves.json"; OUTPUT_PATH=PROJECT_ROOT/"data"/"current"/"L3-003.json"
