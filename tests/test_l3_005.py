...
from goldrush2.collectors.fed import FedCollector, _release_date, candidate_urls, parse_sep_html
from goldrush2.extractors import l3_005
...
def test_collector_snapshot_fallback(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("goldrush2.collectors.fed.candidate_urls", lambda: ["https://x/fomcprojtabl20260916.htm"])
    monkeypatch.setattr("goldrush2.collectors.fed.urlopen", lambda *a, **k: (_ for _ in ()).throw(OSError()))
