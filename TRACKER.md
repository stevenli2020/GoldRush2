...
| DR3-14 | Plan 2 Task 2: approve variable and horizon evidence rules | **Draft submitted for D/Q review** | [`PLAN2_STEP2_EVIDENCE_RULES.md`](PLAN2_STEP2_EVIDENCE_RULES.md) includes Q's locked L4-001 causal/time/threshold/degradation constraints and flags two threshold ambiguities for resolution. |
