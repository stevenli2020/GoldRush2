...
| DR3-19 | Tranche 2 Step 3: WGC extractor implementation | **Approved; complete** | L8/L5 schedule-bound gating, status labels, metadata separation, and 54 focused WSL tests in [`PLAN2_TRANCHE2_STEP3_IMPLEMENTATION.md`](PLAN2_TRANCHE2_STEP3_IMPLEMENTATION.md). |
| DR3-20 | Tranche 2 Step 4: controlled WGC refresh and comparison review | **Complete; submitted for review** | L8/L5 refreshed, 15 strategies rerun, and focused SP-FLOW/SP-CB/SP-L0L5/SP-ANTI-FIAT deltas recorded in [`PLAN2_TRANCHE2_STEP4_COMPLETION_SUMMARY.md`](PLAN2_TRANCHE2_STEP4_COMPLETION_SUMMARY.md). |
| DR3-21 | Tranche 3 Step 1: long-horizon evidence-window audit | **Approved; complete** | Approved 36/120 monthly, 48/132 derived-monthly, and 12/40 quarterly defaults in [`TRANCHE3_STEP1_WINDOW_CALIBRATION.md`](TRANCHE3_STEP1_WINDOW_CALIBRATION.md). |
| DR3-22 | Tranche 3 Step 2: L6-001 source contract and evidence rules | **Approved; complete** | Approved `GPRD_ACT`, explicit vintage dates, Monday/next-business-day tolerance, and long-horizon `NOT_APPLICABLE` rules in [`TRANCHE3_STEP2_L6_RULES.md`](TRANCHE3_STEP2_L6_RULES.md). |
| DR3-23 | Tranche 3 Step 3: window and L6 implementation | **Implemented; awaiting Step 4 authorization** | Shared monthly/quarterly defaults, L4 derived-statistic minimums, L6 vintage freshness gating, and regression fixtures implemented in [`TRANCHE3_STEP3_IMPLEMENTATION.md`](TRANCHE3_STEP3_IMPLEMENTATION.md). |
