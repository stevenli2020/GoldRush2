...
| DR3-15 | Plan 2 Task 3: implement frequency-aware extraction corrections | **In progress; L4-001 tranche implemented** | [`PLAN2_STEP3_IMPLEMENTATION.md`](PLAN2_STEP3_IMPLEMENTATION.md) records publication-aligned `CPI_YoY_12m_MA`, exact thresholds, degradation logic, and tests. Other variables remain unchanged. |
