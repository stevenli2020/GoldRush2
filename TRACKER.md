...
| DR3-16 | Plan 2 Task 4: refresh, rerun, and review corrected outlook | **P0 correction complete; review reopened** | FRED `realtime_start` was incorrectly treated as publication date and stale gating used it. See [`PLAN2_STEP4_P0_BUG_REPORT.md`](PLAN2_STEP4_P0_BUG_REPORT.md); Tranche 2 is blocked. |
