...
| DR3-21 | Tranche 3 Step 1: long-horizon evidence-window audit | **Draft submitted for D/Q review** | Monthly/quarterly inventory and proposed frequency-aware minimums in [`TRANCHE3_STEP1_WINDOW_CALIBRATION.md`](TRANCHE3_STEP1_WINDOW_CALIBRATION.md). No extractor changes. |
| DR3-22 | Tranche 3 Step 2: L6-001 source contract and evidence rules | **Draft submitted for D/Q review** | Recent GPR `GPRD_ACT` source, stale-gap diagnosis, vintage alignment, and degradation rules in [`TRANCHE3_STEP2_L6_RULES.md`](TRANCHE3_STEP2_L6_RULES.md). No extractor changes. |
