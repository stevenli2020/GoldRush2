...
| DR3-17 | Tranche 2 Step 1: WGC source contract inventory | **Draft submitted for D/Q review** | L8-001/L5-001 shared WGC collector contract, publication-date findings, revision/cadence gaps, and no-mtime rule in [`PLAN2_TRANCHE2_STEP1_WGC_SOURCE_CONTRACTS.md`](PLAN2_TRANCHE2_STEP1_WGC_SOURCE_CONTRACTS.md). |
| DR3-18 | Tranche 2 Step 2: WGC evidence-rule draft | **Draft submitted for D/Q review** | L8-001/L5-001 calendar, direction, applicability, confidence, and degradation rules in [`PLAN2_TRANCHE2_STEP2_WGC_EVIDENCE_RULES.md`](PLAN2_TRANCHE2_STEP2_WGC_EVIDENCE_RULES.md). |
